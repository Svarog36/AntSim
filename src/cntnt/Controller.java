...
//            agents.add(new Agent(angle, new double[] {Main.WINDOW_WIDTH / 2. + Math.cos(angle + Math.PI) * 200 * Math.random()*2, Main.WINDOW_HEIGHT / 2. + Math.sin(angle + Math.PI) * 200 * Math.random()*2}, Main.AGENT_SPEED));
//        }
...
//            agents.add(new Agent(Math.PI, new double[] {Main.WINDOW_WIDTH * 0.8, Main.WINDOW_HEIGHT / 2.0 + Main.AGENT_SIZE * 3}, Main.AGENT_SPEED));
        ...
        //Rectangle
//        for (int i = 0; i < Main.AGENT_NUMBER/80; i++)
//            for ( int j = 0; j < 80; j++){
//                agents.add(new Agent(Math.random() * 2 * Math.PI, new double[] {Main.WINDOW_WIDTH * 0.3 + Main.AGENT_SIZE * j, Main.WINDOW_HEIGHT * 0.2 + Main.AGENT_SIZE * i}, Main.AGENT_SPEED));
//            }
